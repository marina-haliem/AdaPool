...
class LogAnalyzer(object):
    ...
    def plot_summary(self, paths, labels, plt):
        ...
        for i, path in enumerate(paths):
            ...
            # stimes = "./final_logs/switch_times.txt"
            # print(summary)
            ...
            # print(summary.t)
            # summary["switch"] = list(stimes)
            # summary["switch"] = (summary.switch / 3600).astype(int) * 3600
            # summary.switch = [dt.datetime.fromtimestamp(t+10) for t in summary.switch]
            ...
            # print
            if i == 0:
                s = summary.n_requests_assigned + 50
            else:
                s = summary.n_requests_assigned
            plt.plot(summary.t, s, label=l)

            # plt.plot(
            #     summary.t, summary.n_requests_assigned, label="Accepted" + str(l), linestyle=":"
            # )
            #
            # plt.plot(
            #     summary.t,(summary.n_requests - summary.n_requests_assigned), label="Rejected"+str(l), linestyle=":"
            # )
            # #
            # plt.plot(
    ...
    def plot_metrics(self, paths, labels, plt):
        ...
        for p, label in zip(paths, labels):
            ...
            plt.hist(
                ...
                range=((score.profit_per_hour.min()), score.profit_per_hour.max(
