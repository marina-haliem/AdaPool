...
class VehicleState(object):
    ...
    __slots__ = [
        ...
        'driver_base_per_trip', 'mileage', 'agent_type', 'accept_new_request', 'tmp_capacity',
        'init_match_count', 'max_init_matching']
    ...
    def __init__(self, id, location, agent_type):
        ...
        self.tmp_capacity = 0
        self.init_match_count = 0
        # self.max_init_matching = 10
        self.travel_dist = 0
